...
// Chakra imports
import { Box, Flex, Image, Link, StyleProps, Text, useColorModeValue } from '@chakra-ui/react';
// Custom components
import { Card } from '@chakra-ui/react';

import SvgIcon from '@/components/common/icon/SvgIcon';

interface ProjectProps extends StyleProps {
...
const Project: React.FC<ProjectProps> = ({ children, title, ranking, link, image, ...rest }) => {
		...
		<Card bg={bg} {...rest} p="14px">
			<Flex align="center" direction={{ base: 'column', md: 'row' }}>
				...
				<Link href={link} variant="no-hover" me="16px" ms="auto" p="0px !important">
					<SvgIcon icon="material-symbols:edit" color="secondaryGray.500" h="18px" w="18px" />
				</Link>
			</Flex>
		</Card>
	);
