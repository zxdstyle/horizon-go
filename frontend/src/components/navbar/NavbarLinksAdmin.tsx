...
// Chakra Imports
import { Avatar, Button, Flex, Image, Link, Menu, MenuButton, MenuItem, MenuList, Text, useColorModeValue } from '@chakra-ui/react';
// Custom Components
...
import ToggleColorMode from '@/components/navbar/ToggleColorMode';
import SvgIcon from '@/components/common/icon/SvgIcon';

interface NavbarLinksAdminProps {
...
const NavbarLinksAdmin: React.FC<NavbarLinksAdminProps> = ({ children, secondary }) => {
	// Chakra Color Mode
		...
		<Flex w={{ sm: '100%', md: 'auto' }} alignItems="center" flexDirection="row" bg={menuBg} flexWrap={secondary ? { base: 'wrap', md: 'nowrap' } : 'unset'} p="10px" borderRadius="30px" boxShadow={shadow}>
			...
			<Flex bg={ethBg} display={secondary ? 'flex' : 'none'} borderRadius="30px" ms="auto" p="6px" align="center" me="6px">
				<Flex align="center" justify="center" bg={ethBox} h="29px" w="29px" borderRadius="30px" me="7px">
					<SvgIcon icon="mdi:ethereum" color={ethColor} w="9px" h="14px" />
				</Flex>
			...
			<Menu>
				<MenuButton p="0px">
					<SvgIcon icon="mdi:bell-outline" color={navbarIcon} w="18px" h="18px" me="10px" />
				</MenuButton>
			...
			<Menu>
				<MenuButton p="0px">
					<SvgIcon icon="mdi:info-outline" color={navbarIcon} w="18px" h="18px" me="10px" />
				</MenuButton>
			...
			<Menu>
				...
				<MenuList boxShadow={shadow} p="0px" mt="10px" borderRadius="20px" bg={menuBg} border="none">
					...
					<Flex flexDirection="column" p="10px">
						<MenuItem as={NavLink} to="/profile" _hover={{ bg: 'none' }} _focus={{ bg: 'none' }} borderRadius="8px" px="14px">
							<Text fontSize="sm">Profile Settings</Text>
						</MenuItem>
						<MenuItem _hover={{ bg: 'none' }} _focus={{ bg: 'none' }} borderRadius="8px" px="14px">
							<Text fontSize="sm">Newsletter Settings</Text>
						</MenuItem>
						<MenuItem as={NavLink} to="/login" _hover={{ bg: 'none' }} _focus={{ bg: 'none' }} color="red.400" borderRadius="8px" px="14px">
