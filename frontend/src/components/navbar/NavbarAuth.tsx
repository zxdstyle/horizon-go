...
// Chakra imports
import { Box, Button, Flex, Grid, HStack, Icon, Link, Menu, MenuList, Stack, Text, useColorModeValue, useColorMode, useDisclosure, SimpleGrid } from '@chakra-ui/react';
...
export default function AuthNavbar(props) {
	...
	if (props.secondary === true) {
		brand = (
			<Link minW="175px" href={`${process.env.PUBLIC_URL}/#/`} target="_blank" display="flex" lineHeight="100%" fontWeight="bold" justifyContent="center" alignItems="center" color={mainText}>
	...
	const linksAuth = (
		<HStack display={{ sm: 'none', lg: 'flex' }} spacing="12px">
			<Stack direction="row" spacing="4px" align="center" color="#fff" fontWeight="bold" onMouseEnter={onOpenDashboards} onMouseLeave={onCloseDashboards} cursor="pointer" position="relative">
			...
			<Stack direction="row" spacing="4px" align="center" color="#fff" fontWeight="bold" onMouseEnter={onOpenMain} onMouseLeave={onCloseMain} cursor="pointer" position="relative">
				<Text fontSize="sm" color={mainText}>
					Main Pages
				</Text>
				<Box>
			...
			<Stack direction="row" spacing="4px" align="center" color="#fff" fontWeight="bold" onMouseEnter={onOpenNft} onMouseLeave={onCloseNft} cursor="pointer" position="relative">
				<Text fontSize="sm" color={mainText}>
					NFTs
				</Text>
				<Box>
