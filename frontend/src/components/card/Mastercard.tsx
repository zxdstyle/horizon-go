...
const Mastercard: React.FC<MastercardProps> = ({ children, exp, cvv, number, ...rest }) => {
	return (
		<Card backgroundImage={bgMastercard} backgroundRepeat="no-repeat" bgSize="cover" alignSelf="center" w={{ base: '100%', md: '60%', xl: '99%' }} bgPosition="10%" mx="auto" p="20px" {...rest}>
