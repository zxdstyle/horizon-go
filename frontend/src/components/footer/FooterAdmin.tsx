...
const FooterAdmin: React.FC<FooterAdminProps> = ({ children }) => {
	const textColor = useColorModeValue('gray.400', 'white');
	// const { toggleColorMode } = useColorMode();
	return (
		<Box flex="0 0 auto">
			<Flex zIndex="3" flexDirection={{ base: 'column', xl: 'row' }} alignItems={{ base: 'center', xl: 'start' }} justifyContent="space-between" px={{ base: '30px', md: '50px' }} h={16}>
				<Text
					color={textColor}
					textAlign={{
						base: 'center',
