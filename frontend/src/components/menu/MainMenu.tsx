...
interface MainMenuProps extends StyleProps {
	children?: React.ReactNode;
}

const MainMenu: React.FC<MainMenuProps> = ({ children, ...rest }) => {
	...
	return (
		<Menu isOpen={isOpen1} onClose={onClose1}>
			<MenuButton textAlign="center" justifyContent="center" bg={bgButton} _hover={bgHover} _focus={bgFocus} _active={bgFocus} w="37px" h="37px" lineHeight="100%" onClick={onOpen1} borderRadius="10px" {...rest}>
